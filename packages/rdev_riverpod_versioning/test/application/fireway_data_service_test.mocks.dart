...
// in rdev_riverpod_versioning/test/application/fireway_data_service_test.dart.
...
import 'package:rdev_riverpod_versioning/domain/fireway_model.dart' as _i8;
...
/// A class which mocks [FirewayModel].
///
/// See the documentation for Mockito's code generation for more information.
class MockFirewayModel extends _i1.Mock implements _i8.FirewayModel {
  MockFirewayModel() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  String get script => (super.noSuchMethod(
  ...
  @override
  DateTime get installedOn => (super.noSuchMethod(
        Invocation.getter(#installedOn),
  ...
  @override
  int get executionTime => (super.noSuchMethod(
        Invocation.getter(#executionTime),
        returnValue: 0,
      ) as int);
